...
import { Zap, TrendingUp, BarChart3, Shield, ArrowRight, Calculator, LogOut } from 'lucide-react';
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-blue-500/20 backdrop-blur-sm border border-blue-500/30 flex items-center justify-center shadow-lg shadow-blue-500/20">
              <Calculator className="w-7 h-7 text-blue-400" />
            </div>
            <span className="text-2xl font-bold text-foreground">Patel Digit Tool</span>
          </div>
